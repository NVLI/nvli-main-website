...
(function() {
    ...
    a.prototype = {
        ...
        newan: function(i, c) {
            ...
            h.editor.VideoJS = this.player.id_;
            h.adder.show();
        ...
        showAnnotation: function(f) {
            ...
            if (c) {
                ...
                this.rs.bar.el_.style.width = e + "%";
                var i = k ? this.rs[((g - d) / g < 0.1) ? "left" : "right"].el_ : this.rs.bar.el_,
                    j = $(this.rs.left.el_).parent()[0];
        ...
        hideAnnotation: function() {
            this.rs.hide();
            this.rs.showPanel();
            var d = $(this.rs.left.el_).parent()[0];
            var c = $(this.rs.right.el_).parent()[0];
        ...
        refreshDisplay: function() {
            ...
            this._sortByDate(j);
            $(this.AnDisplay.el_).find("span").remove();
            $(this.player.el_).find(".vjs-anpanel-annotation .annotation").remove();
            for (var k in j) {
                var g = j[k];
                if (this._isVideoJS(g)) {
                    ...
                    this.AnDisplay.el_.appendChild(i);
            ...
            var e = this.rs._seconds(parseFloat(this.rsdl.el_.style.left) / 100),
                f = this.rs._seconds(parseFloat(this.rsdr.el_.style.left) / 100);
        ...
        showBetween: function(c, h, d, f) {
            var g = this.player.duration(),
                c = c || 0,
                h = h || g,
                n = $.makeArray($(this.player.el_).find(".vjs-anpanel-annotation .annotator-hl")),
                k = 0;
            for (var l in n) {
        ...
        setposBigNew: function(d) {
            var d = d || "ul",
                c = this.player.BigNewAnnotation.el_;
            videojs.removeClass(c, "ul");
            videojs.removeClass(c, "ur");
            videojs.removeClass(c, "c");
            videojs.removeClass(c, "bl");
            videojs.removeClass(c, "br");
            videojs.addClass(c, d)
        },
        pressedKey: function(e) {
            ...
            if (typeof e != "undefined" && e == 73) {
                ...
                if (typeof e != "undefined" && e == 79) {
                    if (this.rs.bar.el_.style.visibility == "hidden") {
        ...
        refreshDesignPanel: function() {
            var e = this.player,
                c = parseFloat($(this.backDSBar.el_).css("width")),
                g = parseFloat($(e.el_).css("height")),
                f = parseFloat($(e.controlBar.el_).css("height")),
                d = (g - f) / c - 5;
            this.BackAnDisplay.el_.style.height = this.backDSBar.el_.style.height = (d + "em");
            this.BackAnDisplay.el_.style.top = this.backDSBar.el_.style.top = "-" + (d + 3 + "em");
            this.BackAnDisplayScroll.el_.children[0].style.top = "-" + (d + 5 + "em");
            this.backDSTime.el_.children[0].style.top = "-" + (d + 5 + "em")
        },
        _reset: function() {
            this.hideDisplay();
            this.hideAnnotation();
        ...
        _setOverRS: function(g) {
            var i = this.player.annotator,
                ...
                c = videojs.findPosition(this.rs.left.el_),
                f = videojs.findPosition(this.rs.right.el_),
                e = videojs.findPosition(h),
                d = {};
        ...
        _isVideoJS: function(h) {
            ...
            if (d) {
                var k = (i && typeof this.player.techName != "undefined") ? (this.player.techName == "Youtube") : false,
                    ...
                    g = k ? l.options_.sources[0].src : l.options_.sources[0].src.substring(0, l.options_.sources[0].src.lastIndexOf("."));
                j = (e == g)
            }
            return (i && c && d && j && m)
        },
    ...
    videojs.ControlBar.prototype.options_.children.AnContainerButtons = {};
    videojs.ControlBar.prototype.options_.children.BackAnDisplay = {};
    videojs.ControlBar.prototype.options_.children.BackAnDisplayScroll = {};
    ...
    videojs.RangeSelectorDisplay.prototype.getWidth = function() {
        var c = $(this.an.rsdl.el_).find(".vjs-selector-arrow")[0];
    ...
    videojs.RangeSelectorDisplay.prototype.setPosition = function(l, f, k) {
        ...
        var i = this.an.rsdl.el_,
            g = this.an.rsdr.el_,
            j = this.an[l === 0 ? "rsdl" : "rsdr"].el_;
        if ((l === 0 ? this.updateLeft(f) : this.updateRight(f))) {
            ...
            var c = this.an.rsdbl.el_,
                m = this.an.rsdbr.el_,
                d = parseFloat(g.style.left) - parseFloat(i.style.left);
            if (l === 0) {
                c.children[0].innerHTML = videojs.formatTime(this.rs._seconds(f))
            } else {
                m.children[0].innerHTML = videojs.formatTime(this.rs._seconds(f))
            }
    ...
    videojs.RangeSelectorDisplay.prototype.updateLeft = function(g) {
        var e = this.an.rsdr.el_.style.left != "" ? this.an.rsdr.el_.style.left : 100;
    ...
    videojs.RangeSelectorDisplay.prototype.updateRight = function(d) {
        var c = this.an.rsdl.el_.style.left != "" ? this.an.rsdl.el_.style.left : 0;
    ...
    videojs.AnDisplay.prototype.onMouseDown = function(i) {
        ...
        if (h.hasClass("annotator-hl")) {
            ...
            g.style.top = (j + f - this.el_.scrollTop / c) + "em";
    ...
    videojs.AnDisplay.prototype.onMouseUp = function(h) {
        ...
        if (g.hasClass("annotator-hl")) {
            ...
            var f = (-1) * parseFloat($(this.el_).parent()[0].style.top),
        ...
        if (!this.transition && !this.an.rsdl.pressed && !this.an.rsdr.pressed) {
            ...
            if (typeof e != "undefined" && $(e[1]).hasClass("annotation")) {
                var d = document.createElement("div"),
                    ...
                    i = parseFloat(this.an.BackAnDisplay.el_.style.height),
                ...
                d.style.top = ((ElemTop + 1) - this.el_.scrollTop / emtoPx) + "em";
                d.style.height = ((i - ElemTop + 2) + this.el_.scrollTop / emtoPx) + "em";
                g.style.top = (i + 2) + "em";
    ...
    videojs.AnDisplay.prototype.countVisibles = function() {
        var d = $.makeArray(this.el_.children);
        var f = 0;
        for (var c in d) {
            var e = d[c];
    ...
    videojs.AnStat.prototype.paintCanvas = function() {
        var o = this.canvas.getContext("2d"),
            ...
            i = this.an.AnDisplay.el_.children.length;
    ...
    videojs.BackAnDisplayScroll.prototype.init_ = function() {
        ...
        var c = this,
            d;
        $(this.an.AnDisplay.el_).bind("DOMMouseScroll", function(f) {
        ...
        $(this.an.AnDisplay.el_).bind("mousewheel", function(f) {
    ...
    videojs.ScrollBarSelector.prototype.setPosition = function(g, f) {
        ...
        if (f) {
            ...
            this.Timeout = window.setTimeout(function() {
                videojs.addClass(c.an.backDSBar.el_, "disable")
            }, 1000)
        }
    ...
    videojs.BackAnDisplayScrollTime.prototype.setTimes = function() {
        ...
        if (d.top != "Invalid Date") {
            ...
            $(this.el_).find(".vjs-up-scrolltime-annotation span")[0].innerHTML = d.top
        } else {
        ...
        if (d.bottom != "Invalid Date") {
            ...
            $(this.el_).find(".vjs-down-scrolltime-annotation span")[0].innerHTML = d.bottom
        } else {
    ...
    videojs.BackAnDisplayScrollTime.prototype.getAnnotationPosition = function() {
        var d = this.an.backDSBarSel,
            e = d.parseMaxPercent(parseFloat(d.el_.style.top) / 100),
            c = this.an.AnDisplay.el_,
            h = c.scrollHeight,
            j = c.offsetHeight,
            f = h - j,
    ...
    videojs.BackAnDisplayScrollTime.prototype.getTimes = function(e) {
        var e = e || {},
            m = {},
            g, c, h, f, i = $.makeArray(this.an.AnDisplay.el_.children);
        e.top = e.top || 0;
        e.bottom = e.bottom || 0;
        var l = 0,
            d;
    ...
    a.prototype.pluginSubmit = function(n, g) {
        ...
        if (this.EditVideoAn()) {
            var d = this.annotator,
                ...
                c, l = o.options_.sources[0].type.split("/") || "";
            if (typeof g.media == "undefined") {
                g.media = typeof l[0] != "undefined" ? l[0] : "video"
            }
            g.target = g.target || {};
            g.target.container = o.id_ || "";
            g.target.src = o.options_.sources[0].src || "";
            c = (o.options_.sources[0].src.substring(o.options_.sources[0].src.lastIndexOf("."))).toLowerCase();
            c = m ? "Youtube" : c;
            g.target.ext = c || "";
...
// return empty object in OpenVideoAnnotation.
...
OpenVideoAnnotation.Annotator = function(f, m) {
    ...
    for (var h in i) {
        ...
        if (vjs.IS_FIREFOX && typeof m.optionsVideoJS.techOrder != "undefined") {
            g.options_.techOrder = m.optionsVideoJS.techOrder;
            g.src(g.options_.sources)
        }
        this.mplayer[a] = g
    }
    this.annotator.an = {};
    ...
    function k(n) {
        ...
        e(document).mousedown(function(o) {
            d = "";
            for (var n in l) {
                if (e(l[n].el_).find(o.target).length) {
                    d = l[n].id_
                }
            }
            if (c != d) {
    ...
    for (var l in k) {
        ...
        if (typeof d.id != "undefined" && d.id == j) {
            if (this._isVideo(d)) {
                for (var e in m) {
                    var i = m[e];
                    if (i.id_ == d.target.container && i.tech.options_.source.src == d.target.src) {
                        var b = d;
                        var c = function() {
