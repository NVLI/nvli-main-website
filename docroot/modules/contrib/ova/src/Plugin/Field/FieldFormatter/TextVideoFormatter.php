...
/**
 * Plugin implementation of the 'videojs_video_player_text' formatter.
 *
 * @FieldFormatter(
 *   id = "videojs_video_player_text",
 *   label = @Translation("OVA Video Formatter"),
 *   field_types = {
 *     "string",
 *     "text"
 *   }
 * )
 */
class TextVideoFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
